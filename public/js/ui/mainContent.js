...
import { formatDuration } from '../utils.js?v=2.1.0';
import { processPlayerData } from '../processor.js?v=2.1.0';
import { fetchDps } from '../api.js?v=2.1.0';
...
export function renderPlayerView(data, player, fightInfo) {
    ...
    let bossIconHtml = isOverall ? '' : `<img src="${basePath}/images/targets/t-${bossSlug}.png?v=${cacheBuster}" style="height: 40px; vertical-align: middle; margin-right: 12px; border-radius: 6px;" onerror="this.src='${basePath}/assets/icons/inv_misc_questionmark.jpg'; this.onerror=null;">`;
