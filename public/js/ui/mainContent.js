...
export function renderPlayerView(data, player, fightInfo) {
    ...
    let bossIconHtml = isOverall ? '' : `<img src="./assets/fights/pic-${bossSlug}.png?v=${cacheBuster}" style="height: 40px; vertical-align: middle; margin-right: 12px; border-radius: 6px;" onerror="this.src='./assets/icons/inv_misc_questionmark.jpg'; this.onerror=null;">`;
